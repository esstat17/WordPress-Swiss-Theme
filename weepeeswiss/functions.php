...
function weepeeswiss_widgets_init() {
	...
	register_sidebar( array(
		...
		'before_widget' => '<div id="%1$s" class="widget well well-bg %2$s">',
		'after_widget'  => '</div>',
	...
	register_sidebar( array(
		'name'          => __( 'Top Toolbar', 'weepeeswiss' ),
		'id'            => 'top-toolbar',
		'description'   => __( 'Appears in the Top Most of the Header. e.g. Contact #, Info Text, etc.', 'weepeeswiss' ),
		'before_widget' => '<div id="%1$s" class="widget widget-top %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<span class="widget-title">',
		'after_title'   => '</span>',
	...
	register_sidebar( array(
		...
		'after_widget'  => '</div>',
		'before_title'  => '<span class="widget-title footer-txt">',
		'after_title'   => '</span>',
	) );
	register_sidebar( array(
